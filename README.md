...
O projeto original está disponível no [Figma](https://www.figma.com/design/qkh6H1cHSAkDZDvqnQGFSY/CalendarioCopa).
...
Para dúvidas ou sugestões, entre em contato através do [GitHub Issues](https://github.com/seu-usuario/CalendarioCopa2026/issues).
